...
describe('DecisionDx-UMSeq Online Order Submission Suite', function() {
    ...
    it("Verify DecisionDx-UMSeq Test Created and Submitted Flow", function()  {
        ...
        //cy.get(':nth-child(4) > .rounded-md > .px-4').scrollIntoView().should('have.text','DecisionDx-UMSeq').should('be.visible').and('exist').wait(500)
    ...
    it("Verify DecisionDx-UMSeq Test Created with Save and Exit Flow", function()  {
