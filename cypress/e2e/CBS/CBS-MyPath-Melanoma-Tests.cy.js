...
describe('MyPath-Melanoma Online Order Submission Suite', function() {
    
    
    it("Verify MyPath-Melanoma Test Created and Send for approval Flow", function()  {
        ...
        cy.get('[type="submit"]').contains("Sign In").should('be.visible').and('exist').and('contain','Sign In').click()                                                  // Get submit btn by btn type and cick on it   >> Best Practise                                
                                                                ...
                                                                // Order Creation and Check Pending Approval status Flow //          
        ...
        cy.contains('p', 'MyPath Melanoma').scrollIntoView().should('be.visible').and('exist').click().wait(500)                                                          // Tapping to MyPath Melanoma Test        
        ...
        cy.get('label[for="YesisPrimaryCutaneousMelanocyticNeoplasm"]').click()
        ...
        cy.get('#notes').type('Testing notes')                                                                                                                              // INput Notes text
        
        cy.get('.primaryBtn').should('be.visible').should('be.enabled').and('exist').click().wait(5000)                                                                                          // Press Submit btn                                                                                                                                       
        cy.contains('p', 'Test Submission').should('be.visible').and('exist')
    ...
    it("Verify MyPath-Melanoma Test Created and Submitted Status Flow", function()  {
    ...
    it("Verify MyPath-Melanoma Test Created with pending submission Status Flow", function()  {
    ...
    it("Verify MyPath-Melanoma Test Created with In Progress Status Flow", function()  {
...
describe('MyPath-Melanoma Online Order Edit Flows Suite', function() {

    it.skip("Verify MyPath-Melanoma Test edited from In Progress to Send for Approval Status", function()  {
    
    })
    
    it.skip("Verify MyPath-Melanoma Test edited from In Progress to Pending Submission Status", function()  {
    
    })

    it.skip("Verify MyPath-Melanoma Test edited from In Progress to Submit State Status", function()  {
    
    })

    it.skip("Verify MyPath-Melanoma Test edited from Send for Approval to In Progress Status", function()  {
    
    })

    it.skip("Verify MyPath-Melanoma Test edited from Send for Approval to Pending Submission Status", function()  {
    
    })

    it.skip("Verify MyPath-Melanoma Test edited from SSend for Approval to Submit Status", function()  {
    
    })

    it.skip("Verify TissueCypher Test edited from Pending Submission to In Progress Status", function()  {
    
    })

    it.skip("Verify TissueCypher Test edited from Pending Submission to Send for Approval Status", function()  {
    
    })

    it.skip("Verify TissueCypher Test edited from Pending Submission to Submit Status", function()  {
